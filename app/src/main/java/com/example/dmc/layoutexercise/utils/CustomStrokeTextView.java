package com.example.dmc.layoutexercise.utils;
...
import com.example.dmc.layoutexercise.R;


/**
 * Created by ASP on 16/11/2016.
 */
...
public class CustomStrokeTextView extends TextView {
    ...
    public CustomStrokeTextView(Context context, AttributeSet attrs, int defStyle) {
